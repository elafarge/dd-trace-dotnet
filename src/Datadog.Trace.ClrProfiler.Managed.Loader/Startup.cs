...
namespace Datadog.Trace.ClrProfiler.Managed.Loader
{
    ...
    public partial class Startup
    {
        ...
        static Startup()
        {
            ...
            AppDomain.CurrentDomain.AssemblyResolve += AssemblyResolve_ManagedProfilerDependencies; // This requires full trust
        ...
        private static void TryLoadManagedAssembly()
        {
            try
            {
                var assembly = Assembly.Load("Datadog.Trace.ClrProfiler.Managed, Version=1.19.4.0, Culture=neutral, PublicKeyToken=def86d061d0d2eeb");
