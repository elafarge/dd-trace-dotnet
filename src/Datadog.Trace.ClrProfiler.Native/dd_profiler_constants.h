...
namespace trace {
  ...
  WSTRING env_vars_to_display[]{
    ...
    environment::dotnet_startup_hook_enabled,
  ...
  WSTRING managed_profiler_full_assembly_version = "Datadog.Trace.ClrProfiler.Managed, Version=1.19.4.0, Culture=neutral, PublicKeyToken=def86d061d0d2eeb"_W;
